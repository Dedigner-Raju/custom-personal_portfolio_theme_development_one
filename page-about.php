<?php get_header(); ?> 
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="about-me-img mb-30">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/aboutme.png" alt="">
                        </div>
                    </div>
        ...
        <!-- Contact Info Start -->
        <div class="contact-info-area w-padding2" data-background="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/section_bg04.jpg">
            <div class="container">
