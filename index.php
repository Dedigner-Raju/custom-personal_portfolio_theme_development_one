   ...
   <!-- main body section start -->
    <main>
     <!-- slider Area Start-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            ...
                                            <div class="single-services mb-30">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/service/services1.png" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <!-- Single -->
                                                    <div class="single-services mb-30">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/service/services2.png" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <!-- Single -->
                                                    <div class="single-services mb-30">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/service/services3.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/service/services4.png" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/service/services5.png" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/service/services6.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="blog-active">
                                ...
                                <div class="blog-wrapper">
                                    ...
                                    <div class="blog-top">
                                            <div class="person-img">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/blog1.png" alt="">
                                            </div>
                            ...
                            <div class="col-xl-4">
                                <div class="blog-wrapper">
                                    ...
                                    <div class="blog-top">
                                            <div class="person-img">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/blog2.png" alt="">
                                            </div>
                                            <div class="comment-person">
                                                <h2>Bradley Erickson</h2>   
                            ...
                            <div class="col-xl-4">
                                <div class="blog-wrapper">
                                    ...
                                    <div class="blog-top">
                                            <div class="person-img">
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/blog3.png" alt="">
                                            </div>
                                            <div class="comment-person">
                                                <h2>Bradley Erickson</h2>   
                                                <span>UI/UX Designer</span>
            ...
            <div class="container">
                <div class="brand-active brand-border pt-50 pb-40">
                    <div class="single-brand">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/brand1.png" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/brand2.png" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/brand3.png" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/brand4.png" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/brand2.png" alt="">
                    </div>
        ...
        <!-- Brand Area End -->
        <!-- Contact Info Start -->
        <section class="contact-info-area w-padding2" data-background="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/section_bg04.jpg">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-xl-5 col-lg-7">
                      <div class="contact-caption mb-50">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/gallery/sin.png" alt="">
                      </div>
                    </div>
